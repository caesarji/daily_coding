    ...
    void generate_keys(string key)
    {
        ...
        for(int i=0;i<16;i++)
        {
            if(i==0 || i==1 || i==8 || i==15)
            {
                left = shift_once(left);
                right = shift_once(right);
            }

            else
            {
                left = shift_twice(left);
                right = shift_twice(right);
            }
            ...
            for(int i=0;i<48;i++)    
                round_key += combined[key_comp[i]-1];
    ...
    string encryption(string plain)
    {
        ...
        for(int i=0;i<16;i++)
        {
            ...
            for(int i=0;i<48;i++)    
                right_expanded += right[exp_box[i]-1];
    ...
    int main()
    {
        ...
        string encrypt = encryption(plain);
        ...
        string decrypt = encryption(encrypt);    
